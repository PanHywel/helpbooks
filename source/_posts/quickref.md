...
categories:
    - Other
intro: This is the magic syntax variant manual that you can use on HelpBook.CN, It's a good practice for contributors.
---
...
│   │   ├── awk.md
│   │   ├── vim.md # => helpbook.cn/vim
│   │   ├── php.md
│   │   ├── css.md # => helpbook.cn/css
│   │   ├── ...
│   └── widget   # Widget files
│       └── chmod.html
...
All the magic variants supported by HelpBook.CN
