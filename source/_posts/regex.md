...
- [Regex in Python](#regex-in-python) _(helpbook.cn)_
- [Regex in JavaScript](#regex-in-javascript) _(helpbook.cn)_
- [Regex in PHP](#regex-in-php) _(helpbook.cn)_
- [Regex in Java](#regex-in-java) _(helpbook.cn)_
- [Regex in MySQL](#regex-in-mysql) _(helpbook.cn)_
- [Regex in Vim](/vim#search-and-replace) _(helpbook.cn)_
- [Regex in Emacs](/emacs#search) _(helpbook.cn)_
