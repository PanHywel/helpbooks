...
| `-r`   | grep -r 'helpbook.cn' /var/log/nginx/ | Recursive search _(within subdirs)_                  |
...
### Refer
- [Regex syntax](/regex) _(helpbook.cn)_
- [Regex examples](/regex#regex-examples) _(helpbook.cn)_
